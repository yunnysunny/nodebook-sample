 ...
 */
        ...
        function addCombinator (matcher, combinator, base) {
            ...
            // Check against all ancestor/preceding elements
                : function (elem, context, xml) {
                    let data; let cache; let outerCache;
 ...
 */
    ...
    jQuery.support = (function (support) {
        let all; let a; let input; let select; let fragment; let opt; let eventName; let isSupported; let i;
        let div = document.createElement('div');
        ...
        jQuery(function () {
            let container; let marginDiv; let tds;
            const divReset = 'padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;';
    ...
    jQuery.fn.extend({
        ...
        addClass: function (value) {
            let classes; let elem; let cur; let clazz; let j;
            let i = 0;
            const len = this.length;
        ...
        val: function (value) {
            let ret; let hooks; let isFunction;
            const elem = this[0];
 ...
 */
    ...
    let iframe; let getStyles; let curCSS;
    ...
    if (window.getComputedStyle) {
        ...
        curCSS = function (elem, name, _computed) {
            let width; let minWidth; let maxWidth;
 ...
 */
    ...
    let xhrCallbacks; let xhrSupported;
    let xhrId = 0;
    ...
    function defaultPrefilter (elem, props, opts) {
        ...
        let prop; let value; let toggle; let tween; let hooks; let oldfire;
        const anim = this;
        const orig = {};
        const style = elem.style;
    ...
    jQuery.offset = {
        ...
        setOffset: function (elem, options, i) {
            ...
            const props = {}; let curPosition = {}; let curTop; let curLeft;
