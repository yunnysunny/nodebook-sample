...
![注册显示界面](https://raw.github.com/yunnysunny/expressdemo/master/chapter5/show.png)

输入数据后，点击注册，显示提示信息：

![注册成功显示界面](https://raw.github.com/yunnysunny/expressdemo/master/chapter5/do.png)
